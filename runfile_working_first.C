	 			...
	 			for (int a=0; a<24; ++a)
	 			    {
						...
						cout<< "5th Bin content of fit = "<<grBF->Eval(histo_LED->GetXaxis()->GetBinCenter(5))<<" +/- "<<grBF->GetErrorY(5)<<endl;
						cout<< "5th Bin content of LED = "<<histo_LED->GetBinContent(5)<<" +/- "<<histo_LED->GetBinError(5)<<endl;
