		...
		//rel_err_mu->GetYaxis()->SetTitle("Counts");
	 	...
	 	{	
			...
			if (p == 7) {	for(Int_t r=0; r<=count; ++r) {ANGLES_7[r] = ANGLES[r]; }	counts[p-1] = count;	for(Int_t s=0; s<=count; ++s) {PMT_DATA_NORM[2*p-2][s] = PMT_DATA[2*p-2][s]/g_pos_1;	PMT_DATA_NORM[2*p-1][s] = PMT_DATA[2*p-1][s]/g_pos_1;}}
	 		...
	 		rel_err_w->SetMarkerStyle( 20 ); rel_err_w->SetMarkerSize( 0.4 ); rel_err_w->SetLineColor( kBlack ); rel_err_w->SetMarkerColor( kBlack ); rel_err_w->SetStats(0); rel_err_w->SetRangeUser(min_w,max_w); rel_err_w->Draw( "" );
			c1->Update(); c1->WaitPrimitive(); c1->Print(PdfName_mid ,"pdf");
			rel_err_alpha->SetMarkerStyle( 20 ); rel_err_alpha->SetMarkerSize( 0.4 ); rel_err_alpha->SetLineColor( kBlack ); rel_err_alpha->SetMarkerColor( kBlack ); rel_err_alpha->SetStats(0); rel_err_alpha->SetRangeUser(min_alpha,max_alpha); rel_err_alpha->Draw( "" );
			c1->Update(); c1->WaitPrimitive(); c1->Print(PdfName_mid ,"pdf");
			rel_err_lambda->SetMarkerStyle( 20 ); rel_err_lambda->SetMarkerSize( 0.4 ); rel_err_lambda->SetLineColor( kBlack ); rel_err_lambda->SetMarkerColor( kBlack ); rel_err_lambda->SetStats(0); rel_err_lambda->SetRangeUser(min_lambda,max_lambda); rel_err_lambda->Draw( "" );
			c1->Update(); c1->WaitPrimitive(); c1->Print(PdfName_mid ,"pdf");
			rel_err_theta->SetMarkerStyle( 20 ); rel_err_theta->SetMarkerSize( 0.4 ); rel_err_theta->SetLineColor( kBlack ); rel_err_theta->SetMarkerColor( kBlack ); rel_err_theta->SetStats(0); rel_err_theta->SetRangeUser(min_theta,max_theta); rel_err_theta->Draw( "" );
			c1->Update(); c1->WaitPrimitive(); c1->Print(PdfName_mid ,"pdf");
			rel_err_mu->SetMarkerStyle( 20 ); rel_err_mu->SetMarkerSize( 0.4 ); rel_err_mu->SetLineColor( kBlack ); rel_err_mu->SetMarkerColor( kBlack ); rel_err_mu->SetStats(0); rel_err_mu->SetRangeUser(min_mu,max_mu); rel_err_mu->Draw( "" );
			c1->Update(); c1->WaitPrimitive(); c1->Print(PdfName_mid ,"pdf");
			...
			auto gr_5 = new TGraphErrors(counts[4],ANGLES_5,PMT_DATA[8],X_ERR,PMT_DATA[9]);	gr_5->SetMarkerColor(5); gr_5->SetLineColor(5); gr_5->SetMarkerStyle(8); gr_5->SetName("Position 5"); gr_5->SetTitle("Position 5");
			auto gr_6 = new TGraphErrors(counts[5],ANGLES_6,PMT_DATA[10],X_ERR,PMT_DATA[11]); gr_6->SetMarkerColor(6); gr_6->SetLineColor(6); gr_6->SetMarkerStyle(8); gr_6->SetName("Position 6"); gr_6->SetTitle("Position 6");
			auto gr_7 = new TGraphErrors(counts[6],ANGLES_7,PMT_DATA[12],X_ERR,PMT_DATA[13]); gr_7->SetMarkerColor(7); gr_7->SetLineColor(7); gr_7->SetMarkerStyle(8); gr_7->SetName("Position 7"); gr_7->SetTitle("Position 7");
			mg->Add(gr_1);
			mg->Add(gr_2);
			mg->Add(gr_3);
			mg->Add(gr_4);
			...
			auto gr2_3 = new TGraphErrors(counts[2],ANGLES_3,PMT_DATA_NORM[4],X_ERR,PMT_DATA_NORM[5]);	gr2_3->SetMarkerColor(3); gr2_3->SetLineColor(3); gr2_3->SetMarkerStyle(8); gr2_3->SetName("Position 3"); gr2_3->SetTitle("Position 3");
			auto gr2_4 = new TGraphErrors(counts[3],ANGLES_4,PMT_DATA_NORM[6],X_ERR,PMT_DATA_NORM[7]);	gr2_4->SetMarkerColor(4); gr2_4->SetLineColor(4); gr2_4->SetMarkerStyle(8); gr2_4->SetName("Position 4"); gr2_4->SetTitle("Position 4");
			auto gr2_5 = new TGraphErrors(counts[4],ANGLES_5,PMT_DATA_NORM[8],X_ERR,PMT_DATA_NORM[9]);	gr2_5->SetMarkerColor(5); gr2_5->SetLineColor(5); gr2_5->SetMarkerStyle(8); gr2_5->SetName("Position 5"); gr2_5->SetTitle("Position 5");
			auto gr2_6 = new TGraphErrors(counts[5],ANGLES_6,PMT_DATA_NORM[10],X_ERR,PMT_DATA_NORM[11]); 	gr2_6->SetMarkerColor(6); gr2_6->SetLineColor(6); gr2_6->SetMarkerStyle(8); gr2_6->SetName("Position 6"); gr2_6->SetTitle("Position 6");
			auto gr2_7 = new TGraphErrors(counts[6],ANGLES_7,PMT_DATA_NORM[12],X_ERR,PMT_DATA_NORM[13]); 	gr2_7->SetMarkerColor(7); gr2_7->SetLineColor(7); gr2_7->SetMarkerStyle(8); gr2_7->SetName("Position 7"); gr2_7->SetTitle("Position 7");
	 		mg2->Add(gr2_1);
			mg2->Add(gr2_2);
			mg2->Add(gr2_3);
			mg2->Add(gr2_4);
