	 			...
	 			for (int a=0; a<24; ++a)
	 			    {
						...
						cout<< "25th Bin content of fit = "<<grBF->GetBinContent(25)<<" +/- "<<grBF->GetBinError(25)<<endl;
						cout<< "25th Bin content of LED = "<<histo_LED->GetBinContent(25)<<" +/- "<<histo_LEDF->GetBinError(25)<<endl;
